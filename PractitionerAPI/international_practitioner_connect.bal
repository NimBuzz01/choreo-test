...
public isolated class InternationalPractitionerSourceConnect {
    ...
    *PractitionerSourceConnect;
    ...
    isolated function search(map<r4:RequestSearchParameter[]> searchParameters, r4:FHIRContext ctx) returns r4:Bundle|Practitioner[]|r4:FHIRError {
        ...
        practitioners.push(example);
        practitioners.push(example1);
        return practitioners;
    }

    isolated function create(r4:FHIRResourceEntity practitioner, r4:FHIRContext ctx) returns string|r4:FHIRError {
